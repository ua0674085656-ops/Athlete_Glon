...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle state) {
        ...
        // WebView игнорирует setPadding — передаём инсеты в страницу как CSS-переменные
        ViewCompat.setOnApplyWindowInsetsListener(web, (v, insets) -> {
            Insets bars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            satTop = bars.top;
            satBottom = bars.bottom;
            web.post(() -> web.evaluateJavascript(
                    "window.__setSat && window.__setSat(" + satTop + "," + satBottom + ")", null));
    ...
    public class Bridge {
        ...
        @JavascriptInterface
        public int satTop() { return satTop; }

        @JavascriptInterface
        public int satBottom() { return satBottom; }
